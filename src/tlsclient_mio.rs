...
#[cfg(feature = "dangerous_configuration")]
fn apply_dangerous_options(args: &BenchArgs, cfg: &mut rustls::ClientConfig) {
...
fn apply_dangerous_options(args: &BenchArgs, _: &mut rustls::ClientConfig) {
...
fn make_config(args: &BenchArgs) -> Arc<rustls::ClientConfig> {
